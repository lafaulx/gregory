/*
	Ultimate Flëve Calendar module
*/
...
/*
	...
	Constructor only creates DOM, to init dat please call Calendar.init({date: new Date()}); for example;
*/
/*global jQuery*/
...
Gregory.prototype.init = function(state) {
	var self = this;
...
Gregory.prototype.changeDisplayState = function(displayState) {
	var self = this;
...
Gregory.prototype.generateDOM = function() {
	var self = this,
...
Gregory.prototype.generateCalendar = function() {
	var self = this;
...
Gregory.prototype.generateDayCalendar = function() {
	var self = this,
...
Gregory.prototype.generateMonthCalendar = function() {
	var self = this,
		html = '<ul class="month">',
		month = 0;
...
Gregory.prototype.generateYearCalendar = function() {
	var self = this,
		html = '<ul class="year">',
...
Gregory.prototype.decrementMonth = function(year, month) {
	var self = this,
		result = {};
...
Gregory.prototype.incrementMonth = function(year, month) {
	var self = this,
		result = {};
...
Gregory.prototype.setDisplayState = function(displayState) {
	var self = this;
...
Gregory.prototype.setSelectedState = function(selectedState) {
	var self = this;
